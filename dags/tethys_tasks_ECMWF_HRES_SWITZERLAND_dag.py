...
'''
docker-compose run --rm tethys-tasks ECMWF_HRES_TP_SWITZERLAND update --class_kwargs "{\"date_from\": \"'2025-05-01'\", \"download_from_origin\": \"True\"}"
'''
